...
export const Navbar = () => {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${isScrolled ? "bg-surface/90 backdrop-blur-md py-4" : "bg-transparent py-6"}`}
    >
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="md:hidden absolute top-full left-0 w-full bg-surface border-b border-brand-900/10 shadow-xl"
          >
